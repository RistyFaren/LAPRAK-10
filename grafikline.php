...
$Taiwan = mysqli_query($conn, "SELECT * FROM tb_covid19 WHERE negara='Taiwan'");
...
var data = {
            labels: ["Total Cases","Total Death","Total Recover","Active Cases", "Total Tests"],
            datasets: [
                {
                    label: "India",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($india)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Korea Selatan",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($korsel)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Turkey",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($turkey)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Vietnam",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($vietnam)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Japan",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($japan)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Iran",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($iran)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Indonesia",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($indo)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Malaysia",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($malay)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                },
                {
                    label: "Taiwan",
                    fill: false,
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($Taiwan)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
               ...
               
               {
                    ...
                    data: [<?php while ($p = mysqli_fetch_array($israel)) { echo '"' . $p['TotalCases'] . '","' . $p['TotalDeaths'] . '","' . $p['TotalRecovered'] . '","' . $p['ActiveCases'] . '","' . $p['TotalTests'] . '",';}?>]
                }
                ]
        };
